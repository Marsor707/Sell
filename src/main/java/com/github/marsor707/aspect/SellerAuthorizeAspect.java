package com.github.marsor707.aspect;
...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.github.marsor707.controller.Seller*.*(..))" +
            "&& !execution(public * com.github.marsor707.controller.SellerUserController.*(..))")
    public void verify() {
